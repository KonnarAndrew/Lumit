    ...
    (
      ...
      items: () => [
        MenuEntry(l10n.newComposition,
            ...
            action: 'comp.new'),
        // Beside it, because the two make the same kind of thing by the same
        // dialogue and differ only in what is inside (docs/impl/node-graph-comp.md
        // §4.4). No chord: the keymap has none to teach.
