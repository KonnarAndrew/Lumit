...
3. **Never hand-edit `app_ar.arb`, `app_de.arb`, `app_es.arb`, `app_kk.arb`, `app_pl.arb`,
   `app_pt.arb`, `app_uk.arb`, `app_zh.arb` or `app_zh_Hant.arb`.** Those belong to the ingest tool. A fix typed here is
